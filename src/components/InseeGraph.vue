<template>
  <div>
    <div class="relative flex justify-around" v-if="graph && graph.proprio">
      <div class="p-3 w-80 mr-10">
        ...
        <div class="mt-8">
          ...
          <div class="flex items-center text-gray-500 mt-1">
            ...
            <div class="text-gray-500 mr-1">{{ 100 - graph.proprio }}%</div>
            Locataires
          </div>
        </div>
      </div>
      ...
      <div class="p-3 w-80">
        ...
        <div class="mt-8">
          ...
          <div class="flex items-center text-gray-500 mt-1">
            <div class="h-4 w-7 bg-gray-500 mr-2 mt-4" />
            <div class="text-gray-500 mr-1">{{ graph.sociopro }}%</div>
    ...
    <div class="flex justify-around mt-12">
      <div class="p-3 w-80 mr-10" v-if="chartData">
        ...
        <div class="mt-8" v-if="graph.logmentType">
          <div class="flex items-center" style="color: rgb(0, 152, 212)">
            <div
              class="h-4 w-7 mr-2 mt-4"
              style="background-color: rgb(0, 152, 212)"
            ...
            <div class="mr-1 w-14" style="color: rgb(0, 152, 212)">
              {{ graph.logmentType.nbResidentPct.toFixed(2) }}%
            </div>
          ...
          <div class="flex items-center mt-1 text-gray-500">
            ...
            <div class="text-gray-500 mr-1 w-14">
              {{ graph.logmentType.nbSecPct.toFixed(2) }}%
            </div>
          ...
          <div class="flex items-center mt-1">
            ...
            <div class="text-black mr-1 w-14">
              {{ graph.logmentType.nbVacPct.toFixed(2) }}%
            </div>
            Logements vacants
          </div>
        </div>
      ...
      <div class="p-3 w-80" v-if="graph && graph.sexeAge">
          ...
          <div class="w-full flex relative">
            ...
            >
              <div
                class="h-6 w-8 mt-3"
                style="background-color: rgb(0, 152, 212)"
                :style="'width:' + graph.sexeAge.h19 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3"
                style="background-color: rgb(0, 152, 212)"
                :style="'width:' + graph.sexeAge.h24 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3"
                style="background-color: rgb(0, 152, 212)"
                :style="'width:' + graph.sexeAge.h39 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3"
                style="background-color: rgb(0, 152, 212)"
                :style="'width:' + graph.sexeAge.h54 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3"
                style="background-color: rgb(0, 152, 212)"
                :style="'width:' + graph.sexeAge.h64 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3"
                style="background-color: rgb(0, 152, 212)"
                :style="'width:' + graph.sexeAge.h100 * 2 + '%'"
              />
            </div>
            <div class="w-1/2 pb-3 border-l border-black">
              <div
                class="h-6 w-8 mt-3 bg-gray-500"
                :style="'width:' + graph.sexeAge.f19 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3 bg-gray-500"
                :style="'width:' + graph.sexeAge.f24 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3 bg-gray-500"
                :style="'width:' + graph.sexeAge.f39 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3 bg-gray-500"
                :style="'width:' + graph.sexeAge.f54 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3 bg-gray-500"
                :style="'width:' + graph.sexeAge.f64 * 2 + '%'"
              />
              <div
                class="h-6 w-8 mt-3 bg-gray-500"
                :style="'width:' + graph.sexeAge.f100 * 2 + '%'"
              />
            </div>
...
export default {
  ...
  methods: {
    pieChart() {
      if (this.graph && this.graph.logmentType) {
        let { nbResidentPct, nbSecPct } = this.graph.logmentType;
  ...
  data() {
    return {
      ...
      chartData:
        this.graph && this.graph.logmentType
          ? [
              ['Effort', 'Amount given'],
              ['1', this.graph.logmentType.nbResidentPct],
              ['2', this.graph.logmentType.nbSecPct],
              ['3', this.graph.logmentType.nbVacPct],
            ]
          : null,
      chartOptions: {
