<template>
  <section class="pdf-page">
    ...
    <div
      ...
      v-if="pdfObject.formValues && pdfObject.formValues.graph"
    >
          ...
          <div class="relative pt-2 mt-5">
            ...
            >
              <div
                ...
                :style="{
                  width: 100 - pdfObject.formValues.graph.proprio + '%',
                }"
              />
            </div>
          ...
          <div class="mt-8">
            <div class="flex items-center" style="color: rgb(0, 152, 212)">
              ...
              <div class="mr-1" style="color: rgb(0, 152, 212)">
                {{ pdfObject.formValues.graph.proprio }}%
              </div>
              Propriétaires
            </div>
            <div class="flex items-center mt-1 text-gray-500">
              ...
              <div class="text-gray-500 mr-1">
                {{ 100 - pdfObject.formValues.graph.proprio }}%
              </div>
              Locataires
            </div>
          </div>
        ...
        <div class="p-3 w-80">
          ...
          <div class="relative pt-2 mt-5">
            ...
            >
              <div
                class="h-6 bg-gray-500"
                :style="{ width: pdfObject.formValues.graph.sociopro + '%' }"
              />
            </div>
            <div class="absolute top-0 w-0.5 h-10 bg-black" />
            <div
          ...
          <div class="mt-8">
            <div class="flex items-center" style="color: rgb(0, 152, 212)">
              ...
              />
              <div class="mr-1" style="color: rgb(0, 152, 212)">
                {{ 100 - pdfObject.formValues.graph.sociopro }}%
              </div>
              Employés
            </div>
            <div class="flex items-center mt-1 text-gray-500">
              <div class="h-4 w-7 bg-gray-500 mr-2 mt-4" />
              <div class="text-gray-500 mr-1">
                {{ pdfObject.formValues.graph.sociopro }}%
              </div>
          ...
          <div class="mt-8">
            <div class="flex items-center" style="color: rgb(0, 152, 212)">
              ...
              <div class="mr-1 w-14" style="color: rgb(0, 152, 212)">
                {{
                  pdfObject.formValues.graph.logmentType.nbResidentPct.toFixed(
                    2
                  )
                }}%
              </div>
            ...
            <div class="flex items-center mt-1 text-gray-500">
              ...
              <div class="text-gray-500 mr-1 w-14">
                {{
                  pdfObject.formValues.graph.logmentType.nbSecPct.toFixed(2)
                }}%
              </div>
            ...
            <div class="flex items-center mt-1">
              ...
              <div class="text-black mr-1 w-14">
                {{
                  pdfObject.formValues.graph.logmentType.nbVacPct.toFixed(2)
                }}%
              </div>
              Logements vacants
            </div>
            ...
            <div class="w-full flex relative">
              ...
              >
                <div
                  ...
                  style="background-color: rgb(0, 152, 212)"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.h19 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3"
                  style="background-color: rgb(0, 152, 212)"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.h24 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3"
                  style="background-color: rgb(0, 152, 212)"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.h39 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3"
                  style="background-color: rgb(0, 152, 212)"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.h54 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3"
                  style="background-color: rgb(0, 152, 212)"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.h64 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3"
                  style="background-color: rgb(0, 152, 212)"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.h100 * 2 + '%'
                  "
                />
              </div>
              <div class="w-1/2 pb-3 border-l border-black">
                <div
                  ...
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.f19 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3 bg-gray-500"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.f24 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3 bg-gray-500"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.f39 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3 bg-gray-500"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.f54 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3 bg-gray-500"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.f64 * 2 + '%'
                  "
                />
                <div
                  class="h-6 w-8 mt-3 bg-gray-500"
                  :style="
                    'width:' + pdfObject.formValues.graph.sexeAge.f100 * 2 + '%'
                  "
                />
              </div>
...
export default {
  ...
  methods: {
    pieChart() {
      if (this.pdfObject.formValues && this.pdfObject.formValues.graph) {
        let { nbResidentPct, nbSecPct } =
          this.pdfObject.formValues.graph.logmentType;
  ...
  data() {
    return {
      ...
      chartData: [
        ['Effort', 'Amount given'],
        ['1', this.pdfObject.formValues.graph.logmentType.nbResidentPct],
        ['2', this.pdfObject.formValues.graph.logmentType.nbSecPct],
        ['3', this.pdfObject.formValues.graph.logmentType.nbVacPct],
      ],
      chartOptions: {
